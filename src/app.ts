...
import appointmentRoutes from '@/modules/appointments/appointment.routes'; // Importar rutas de citas
...
app.use('/api/appointments', appointmentRoutes); // Montar rutas de citas
