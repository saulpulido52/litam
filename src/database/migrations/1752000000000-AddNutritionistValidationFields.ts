...
export class AddNutritionistValidationFields1752000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // Crear el tipo enum para verification_status
        await queryRunner.query(`
            CREATE TYPE "nutritionist_verification_status_enum" AS ENUM('pending', 'approved', 'rejected', 'under_review')
        `);
        ...
        await queryRunner.query(`
            ...
            ADD COLUMN "verification_status" "nutritionist_verification_status_enum" NOT NULL DEFAULT 'pending',
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "nutritionist_verification_status_enum"`);
    }
}